    ...
    <div className="content">
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="form-control">
          <input type="text" name='text' placeholder='search' className='search-filter' value={text} onChange={updateFilters} />
        </div>
        {/* end search input */}
        {/* categories */}
        <div className="form-control">
        ...
        <div className="form-control">
          ...
          <div className="colors">
            {colors.map((c, index) => {
              ...
              return <button key={index} style={{ background: c }}
                className={`${c === color ? 'color-btn active' : 'color-btn'}`}
                data-color={c} onClick={updateFilters} name='color'>
        ...
        {/* end of colors */}
        {/* we used the 'datset' attribute above for the color buttons as these color buttons do not have any 'textContent'*/}
        {/* price */}
        <h5>price</h5>
